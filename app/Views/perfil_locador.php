<div class="flex flex-row m-10 gap-10 w-auto mt-12">
    ...
    <div class="flex flex-wrap gap-10 w-2/4">
        ...
        <div class="border-2 border-slate-700 p-3 rounded-md h-64">
            ...
            <div>
                <h4 class="text-amber-300 text-lg">Campo de Futebol</h4>
                <p class="text-sm">Tamanho: 120 x 90m</p>
        ...
        <div class="border-2 border-slate-700 rounded-md h-64 w-44 flex justify-center items-center">
