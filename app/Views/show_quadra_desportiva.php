...
<div class="container mx-auto">
      <h1 class="text-xl text-white mb-10 align-center">Calendário</h1>
      ...
      <div class="max-w-[500px]">
        ...
        <div id="calendar-body" class="text-stone-200">
          <div id="calendar-weekdays" class="grid grid-cols-7 text-start">
            <span class="text-center">Dom</span>
            <span class="text-center">Seg</span>
            <span class="text-center">Ter</span>
            <span class="text-center">Qua</span>
            <span class="text-center">Qui</span>
            <span class="text-center">Sex</span>
            <span class="text-center">Sab</span>
          </div>
      ...
      <p class="text-zinc-200 mt-20">Data selecionada: <span id="selected-date">-</span></p>
    </div>
...
<script>
      ...
      const setSelectedDate = (day, month, year) => {
        ...
        const dateString = new Intl.DateTimeFormat('pt-BR', { dateStyle: 'long' }).format(selectedDate);
