<div class="flex flex-col h-auto w-full items-center justify-center mt-16">
    ...
    <div class="flex flex-wrap items-center justify-center gap-5 m-8">
        <!-- Puxar os dados de todos os estabelecimentos, através das funcionalidades DAO na div -->
            ...
            <div class="flex flex-row p-2 border-2 border-solid border-slate-100 dark:border-zinc-400 m-3 mt-8 rounded-lg shadow-lg">
                ...
                <div class="ml-3 capitalize">
                    <!-- nome
                         ...
                         endereço
                          -->
                    <h3 class="dark:text-amber-300">Nenezão</h3>
    ...
    <div class="flex flex-col h-auto w-full items-center justify-center mt-16">
        ...
        <div class="flex flex-wrap items-center justify-center gap-5 m-8">
            ...
            // Obtendo todas as quadras
            $locadores = $locadorDAO->getAll();

            // Verificando se há quadras para exibir
            if (!empty($locadores)) {
            ...
            ?>
                    <div class="flex flex-row w-96 text-wrap">
                        <div class="flex flex-row p-2 border-2 border-solid border-slate-100 dark:border-zinc-400 m-3 mt-8 rounded-lg shadow-lg">
                            ...
                            <div class="ml-3 capitalize">
                                <h3 class="dark:text-amber-300"><?= $locador->getNome() ?></h3>
                                <p><?= $locador->getCnpj() ?></p>
                            </div>
                        </div>
                    </div>
