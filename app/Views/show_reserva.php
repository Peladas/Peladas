...
<div class="size-full py-4 flex flex-row justify-center gap-2">
    <div class="flex flex-col w-1/2">
        <div>
            <h1 class="dark:text-amber-300 text-center text-2xl">Dados da Quadra Reservada</h1>
        </div>
        <div class="size-full min-h-full flex flex-row items-center justify-center gap-5 py-8">
            <div>
    ...
    <div class="flex flex-col w-1/2 justify-center items-center justify-items-center py-4">
        <div>
            <h1 class="text-2xl text-center dark:text-amber-300">Dados da Reserva</h1>
        </div>

        <div class="size-full min-h-full flex flex-col items-center justify-center gap-5 py-8">

            <div class="flex flex-col md:flex-row py-6 justify-center items-center justify-items-center">
