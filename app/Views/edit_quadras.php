            ...
            <div class="flex flex-col gap-2 mb-7 items-center">
                <div class="w-full">
                    <select id="identificador" name="identificador" class="w-full px-10 peer h-10 px-2 border-2 border-purple-700 dark:border-amber-300 rounded-lg placeholder-transparent dark:bg-zinc-900 bg-transparent text-gray-500" name="select" id="">
                        ...
                        <option value="Areia" <?php echo $quadra->getIdentificador() ?> >Areia</option>
                        <option value="Madeira" <?php echo $quadra->getIdentificador() ?> >Madeira</option>
                        <option value="Concreto" <?php echo $quadra->getIdentificador() ?> >Concreto</option>
                        <option value="Grama Natural" <?php echo $quadra->getIdentificador() ?> >Grama Natural</option>
                        <option value="Grama Sintética" <?php echo $quadra->getIdentificador() ?> >Grama Sintética</option>
                    </select>
