...
<div class="flex justify-center items-center mt-14 mb-10">
    ...
    <div class="container max-w-[900px]">
        ...
        <form action="#" method="post" class="text-center">
            ...
            <div class="flex flex-col gap-2 mb-8 items-center">
                <div class="relative w-2/5">
                    <input type="text" id="quant_min_jogadores" name="quant_min_jogadores" class="peer w-full h-10 px-2 border-b-2 border-amber-300 placeholder-transparent" placeholder=" "value="<?php echo $quadra->getQuantMinJogadores() ?>"/>
