...
<div class="flex flex-col h-auto w-auto m-10 p-5- gap-20 items-center">
    ...
    <div class="flex flex-wrap gap-10 w-auto h-auto">
        ...
        foreach ($quadras as $quadra) { ?>
            <a href="/minhas-quadras/<?php echo $quadra->getId() ?>" class="w-[190px] h-auto border-2 border-slate-700 p-3 rounded-md h-64 hover:scale-110 transition-all">
                ...
                <div class="flex flex-col gap-2">
                    <h4 class="text-amber-300 text-xl md:flex"><?php echo $quadra->getIdentificador() ?></h4>
                    <div class="flex flex-row relative">
                        <p class="text-sm font-medium">Modalidade</p>
                        <p class="text-sm absolute bottom-0 right-0"><?php echo $quadra->getModalidade() ?></p>
                    </div>
                    <div class="flex flex-row relative">
