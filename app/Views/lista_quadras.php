...
<div class="flex flex-col size-full p-5 gap-10 md:gap-16 items-center justify-center flex-wrap">
    ...
    <div class="flex flex-wrap flex-row gap-6 md:gap-10 h-auto w-full items-center justify-center">
        ...
        foreach ($quadras as $quadra) { ?>
            <a href="/minhas-quadras/<?php echo $quadra->getId() ?>" class="w-40 md:w-[190px] gap-2 md:gap-3 h-auto md:h-auto border-2 border-gray-300 dark:border-slate-700 p-3 rounded-md h-64 hover:scale-110 transition-all flex flex-col text-wrap dark:bg-zinc-900">
