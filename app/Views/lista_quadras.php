...
<div class="flex flex-col h-auto m-10 p-5- gap-20">
    <div class="relative">
    ...
    <div class="flex flex-wrap gap-10 w-2/4">
        ...
        foreach ($quadras as $quadra) { ?>
            <a href="/minhas-quadras/<?php echo $quadra->getId() ?>" class="w-[180px] border-2 border-slate-700 p-3 rounded-md h-64 hover:scale-110 transition-all">
                ...
                <div>
                <h4 class="text-amber-300 text-xl"><?php echo $quadra->getIdentificador() ?></h4>
