<div class="flex flex-col items-center justify-center gap-5 flex-grow ">


    <div class="flex flex-col items-center justify-center justify-items-center self-center content-center gap-10">
        <div class="my-8 size-full">

            <h1 class="dark:text-amber-300 text-center text-3xl">Dados da Quadra</h1>
        ...
        <div class="flex flex-col md:flex-row items-center justify-center gap-6">
            <div>
                <div class="border-2 border-gray-300 dark:border-slate-700 p-4 rounded-lg bg-gray-200 dark:bg-slate-950 size-auto flex items-center justify-center">
                    <svg xmlns="http://www.w3.org/2000/svg" class="size-48 md:size-52" viewBox="0 0 576 512">
            ...
            <div class="flex flex-col gap-4 w-full">
                ...
                <div class="flex gap-8 items-center justify-center md:justify-start mt-4">
                    ...
                    <a href="#" onclick="confirmElimination()" class="transform hover:scale-105 px-3 py-2 bg-transparent text-gray-700 dark:text-white border border-gray-300 px-4 py-2 hover:bg-gray-200 hover:text-gray-800 hover:border-gray-400 hover:shadow-lg transform transition-all duration-300">
                        Eliminar
                    </a>
