...
<div class="size-full flex flex-col items-center justify-center gap-5">
    <div class="my-5">
        <h1 class="dark:text-amber-300 mb-5 text-center text-3xl">Dados da Quadra</h1>
    </div>
    <div class="flex flex-col md:flex-row gap-5 items-center justify-center">
        <div>
            <div class="border-2 border-gray-300 dark:border-slate-700 p-4 rounded-lg bg-gray-200 dark:bg-slate-950 size-auto flex items-center justify-center">
                <svg xmlns="http://www.w3.org/2000/svg" class="size-52 fill-black dark:fill-white" viewBox="0 0 576 512">
        ...
        <div class="flex flex-col gap-4 w-full md:w-auto md:ml-12 mt-5 md:mt-0">
            ...
            <div class="flex flex-col gap-4 w-full">
                ...
                <a id="" href="#" onclick="confirmElimination()" class="transform hover:scale-105 px-3 py-2 bg-transparent text-gray-700 dark:text-white border border-gray-300 px-4 py-2 hover:bg-gray-200 hover:text-gray-800 hover:border-gray-400 hover:shadow-lg transform transition-all duration-300">
                    Eliminar
                </a>
                <a id="botaoInativarAtivar" href="#" onclick="toggleQuadraStatus()" class="transform hover:scale-105 px-3 py-2 bg-transparent text-gray-700 dark:text-white border border-gray-300 px-4 py-2 hover:bg-gray-200 hover:text-gray-800 hover:border-gray-400 hover:shadow-lg transform transition-all duration-300">
