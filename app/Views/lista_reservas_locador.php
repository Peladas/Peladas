...
<div class="flex flex-col size-full p-5 items-center justify-center gap-10">
    ...
    <div class="flex flex-wrap gap-16">
        ...
        foreach ($reservasFeitas as $reservaDado) {
    ...
    <h1 class="text-2xl dark:text-amber-300 text-center">Locações Concluídas</h1>

    <div class="flex flex-wrap gap-16">

        <?php

        foreach ($reservasConcluidas as $reservaDado) {
            $reserva = $reservaDado['reserva'];
            $quadra = $reservaDado['quadra'];
            $jogador = $reservaDado['jogador'];
        ?>
