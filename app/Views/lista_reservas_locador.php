...
<div class="flex flex-col size-full p-5 items-center justify-center gap-4">
    ...
    <div class="flex flex-wrap items-center justify-center gap-16 my-4">
        ...
        ?>
            ...
            <a href="/lista-reservas/reserva/<?= $reserva->getId() ?>" class="border bg-transparent rounded-lg py-3 px-5 transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 hover:drop-shadow-lg hover:shadow-slate-900 duration-1500">
