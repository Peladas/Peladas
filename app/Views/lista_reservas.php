...
<div class="flex flex-col h-auto m-10 p-5- gap-20 items-center">
    <div class="relative">
        <p class="text-3xl text-amber-300 text-center font-semibold">Minhas Reservas</p>
    </div>

    <div class="flex flex-wrap gap-10 w-2/4">

        <a href="/cadastro-reserva" class="border-2 border-slate-700 rounded-md h-64 w-44 flex justify-center items-center hover:scale-110 transition-all">
        ...
        foreach ($reservas as $reserva) { ?>
            <a href="/minhas-reservas/<?php echo $reservas->getId() ?>" class="w-[180px] border-2 border-slate-700 p-3 rounded-md h-64 hover:scale-110 transition-all">
                ...
                <div>
                <h4 class="text-amber-300 text-xl"><?php echo $reservas->getTipoReserva() ?></h4>
                    <div class="flex flex-row relative">
                        <p class="text-base font-medium">Horário:</p>
                        <p class="text-sm absolute bottom-0 right-0"><?php echo $reservas->getHorarioReservado() ?></p>
                    </div>
                    <div class="flex flex-row relative">
                        <i class="fa-regular fa-pen-to-square mt-2 ml-[1px]" style="color: #ff8000;"></i>
                        <p class="absolute bottom-0 right-0"><?php echo $reservas->getQuantidadeJogadores() ?></p>
                    </div>
                </div>
            </a>
        <?php } ?>
